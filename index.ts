...
console.log("The converted ammount from PKR To USD is : $" + result);
    ...
    const currentUSD = await inquirer.prompt([{
        ...
        const result = input.amount * currentRIYAL.currentRate;console.log("The converted ammount from USD To RIYAL is : ریال "+ result);
    }
    }
    ...
    const result = input.amount * currentINR.currentRate;console.log("The converted ammount from EURO To INR is : ₹" + result);
...
const result = input.amount * currentEURO.currentRate;
console.log("The converted ammount from EURO To RIYAL is : ریال "+
result);
}
}
...
const result = input.amount * currentUSD.currentRate;
console.log("The converted ammount from INR To USD is : $" + result);}else if(input.currency == "INR" && converted.currency == "EURO"){
    const currentEURO = await inquirer.prompt([
    {
    type: "number",
    name: "currentRate",
